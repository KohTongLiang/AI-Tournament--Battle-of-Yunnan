...
LR                          =      0.7            #   This is the learning rate. High learning rate means faster learning"                     
GAMMA                       =      0.7              #   gamma = discount factor. High gamma value means focus on future rewards "
...
NO_DESTRUCTION              =      0                 
NO_KILL                     =      -5            
PLACING_BOMBS_WITH_NO_AMMO  =      -20
BOMB_IN_RANGE               =      -15
PLACING_BOMB_ON_TOP_OF_BOMB =      -15
EXIST_PENALTY               =      -5
